...
{
    public partial class Responses3 
    {
        ...
        /// <summary>The total number of responses obtained from this server.</summary>
        ...
        public static Responses3 FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Responses3>(data);
        }
