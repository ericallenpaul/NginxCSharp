namespace NginxCSharp
{
    ...
    public partial class HTTPUpstreamConfServer 
    {
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#service"&gt;service&lt;/a&gt; parameter of the HTTP upstream server. This parameter cannot be changed.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#weight"&gt;weight&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        [Newtonsoft.Json.JsonProperty("weight", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Weight { get; set; }
    
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#max_conns"&gt;max_conns&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#max_fails"&gt;max_fails&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#fail_timeout"&gt;fail_timeout&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#slow_start"&gt;slow_start&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#route"&gt;route&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>When &lt;code&gt;true&lt;/code&gt;, adds a &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#backup"&gt;backup&lt;/a&gt; server. This parameter cannot be changed.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#down"&gt;down&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        ...
        /// <summary>Same as the &lt;a href="https://nginx.org/en/docs/http/ngx_http_upstream_module.html#drain"&gt;drain&lt;/a&gt; parameter of the HTTP upstream server.</summary>
        [Newtonsoft.Json.JsonProperty("drain", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static HTTPUpstreamConfServer FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<HTTPUpstreamConfServer>(data);
        }
