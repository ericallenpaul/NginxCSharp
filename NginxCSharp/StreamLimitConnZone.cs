...
{
    public partial class StreamLimitConnZone 
    {
        ...
        /// <summary>The total number of connections accounted as rejected in the &lt;a href="https://nginx.org/en/docs/stream/ngx_stream_limit_conn_module.html#limit_conn_dry_run"&gt;dry run&lt;/a&gt; mode.</summary>
        ...
        public static StreamLimitConnZone FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<StreamLimitConnZone>(data);
        }
