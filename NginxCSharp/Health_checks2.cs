...
{
    public partial class Health_checks2 
    {
        /// <summary>The total number of &lt;a href="https://nginx.org/en/docs/stream/ngx_stream_upstream_hc_module.html#health_check"&gt;health check&lt;/a&gt; requests made.</summary>
        ...
        /// <summary>Boolean indicating whether the last health check request was successful and passed &lt;a href="https://nginx.org/en/docs/stream/ngx_stream_upstream_hc_module.html#match"&gt;tests&lt;/a&gt;.</summary>
        ...
        public static Health_checks2 FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Health_checks2>(data);
        }
