...
{
    public partial class HTTPServerZone 
    {
        /// <summary>The number of client requests that are currently being processed.</summary>
        ...
        public static HTTPServerZone FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<HTTPServerZone>(data);
        }
